...
export default {
  name: "MovieComponent",
  props: ["title", "imageurl", "released", "rating", "imdbid", "clickable"],
  data() {
    return {
      url: "",
      imageStyle: {
...
<template>
  <div class="movie" :class="{ 'movie-hover': clickable }" @click="handleClick">
    <h1>
      {{ title }}
    </h1>
    <div class="image">
      <img :src="url" :width="140" :style="imageStyle" />
    </div>
